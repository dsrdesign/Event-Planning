      ...
      <RootView>
        {/* <View style={{ paddingHorizontal: 20 }}>
         ...
         <View style={{ padding: 25, backgroundColor: '#FFFFFF', marginTop: 10, borderRadius: 5, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
          <Text style={{ fontSize: 28, fontWeight: 'bold', color: '#59570C' }}>Evènements</Text>
          <Pressable onPress={() => router.push(`/(admin)/events/new`)} style={styles.button}>
        ...
        <View style={{flex: 1}}>
          {
            ...
            renderItem={({ item }) =>
              <EventCard event={item} style={{flex: 1 / 2}} path={`/(admin)/events/reservation/${item.id}`}/>
